      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between gap-6">
        ...
        <div className="slidebar w-full md:w-[300px]">
          <div className="box-slidebar mb-5">
            ...
            <div className="py-3">
              <Checkbox name="Category Name (8)" />
              <Checkbox name="Category Name (11)" />
              <Checkbox name="Category Name (15)" />
              <Checkbox name="Category Name (21)" />
              <Checkbox name="Category Name (44)" />
              <Checkbox name="Category Name (18)" />
              <a
          ...
          <div className="box-slidebar mb-5">
            ...
            <div className="py-3">
              <Checkbox name="All Language" />
              <Checkbox name="Arabic (11)" />
              <Checkbox name="English (53)" />
              <Checkbox name="Spanish (22)" />
              <a
                className="flex items-center gap-2 text-sm text-[#2BA149] "
                href="#">
                Show more
          ...
          <div className="box-slidebar mb-5">
            ...
            <div className="py-3">
              <Checkbox name="All Skills" />
              <Checkbox name="Beginner (55)" />
              <Checkbox name="Intermediate (22)" />
              <Checkbox name="High (42)" />
              <a
                className="flex items-center gap-2 text-sm text-[#2BA149] "
                href="#">
                Show more
          ...
          <div className="box-slidebar mb-5">
            ...
            <div className="py-3">
              <Checkbox name="David Millar (10)" />
              <Checkbox name="Wade Warren (13)" />
              <Checkbox name="Jenny Wilson (22)" />
              <Checkbox name="Jacob Jones (42)" />
              <a
                className="flex items-center gap-2 text-sm text-[#2BA149] "
                href="#">
                Show more
